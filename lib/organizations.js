...
define([
    ...
    function (Collection) {
        ...
        organizations.prototype.space_quota_definitions = function (guid) {
            var organization_space_quota_definitions_collection = new Collection();

            organization_space_quota_definitions_collection.api = this.api;
            organization_space_quota_definitions_collection.collection = this.collection + '/' + guid + '/space_quota_definitions';

            return organization_space_quota_definitions_collection;
        };
