...
define([
    ...
    function (Collection) {
        ...
        spaces.prototype.addAuditor = function (org_guid, user_guid, done) {
            var self = this;
            var path = "/v2/spaces/" + org_guid + "/auditors/" + user_guid;
        ...
        spaces.prototype.addDeveloper = function (org_guid, user_guid, done) {
            var self = this;
            var path = "/v2/spaces/" + org_guid + "/developers/" + user_guid;
            this.api.put(path, {status_code: 201}, function (err, res) {
                if (err) {return done(err);}
                done(null);
            });
        ...
        spaces.prototype.addManager = function (org_guid, user_guid, done) {
            var self = this;
            var path = "/v2/spaces/" + org_guid + "/managers/" + user_guid;
            this.api.put(path, {status_code: 201}, function (err, res) {
                if (err) {return done(err);}
                done(null);
            });
        ...
        spaces.prototype.removeAuditor = function (org_guid, user_guid, done) {
            var self = this;
            var path = "/v2/spaces/" + org_guid + "/auditors/" + user_guid;
        ...
        spaces.prototype.removeDeveloper = function (org_guid, user_guid, done) {
            var self = this;
            var path = "/v2/spaces/" + org_guid + "/developers/" + user_guid;
            this.api.delete_(path, {status_code: 201}, function (err) {
                if (err) {return done(err);}
        ...
        spaces.prototype.removeManager = function (org_guid, user_guid, done) {
            var self = this;
            var path = "/v2/spaces/" + org_guid + "/managers/" + user_guid;
            this.api.delete_(path, {status_code: 201}, function (err) {
                if (err) {return done(err);}
