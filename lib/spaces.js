...
define([
    ...
    function (Collection) {
        ...
        spaces.prototype.routes = function (guid) {

            var space_routes_collection = new Collection();

            space_routes_collection.api = this.api;
            space_routes_collection.collection = this.collection + '/' + guid + '/routes';

            return space_routes_collection;
        };
